...
(async () => {
  ...
  try {
    ...
    sessionStorage.setItem('logofooter', data.logoFooter);
    ...
    sessionStorage.setItem('address', Encode64(data.address));
    sessionStorage.setItem('home', Encode64(data.home));
    sessionStorage.setItem('whatsapp', Encode64(data.whatsapp));
    sessionStorage.setItem('emailemp', Encode64(data.emailemp));
    sessionStorage.setItem('instagram', Encode64(data.instagram));
    sessionStorage.setItem('linkedin', Encode64(data.linkedin));
    sessionStorage.setItem('showbeneficio', Encode64(data.showBeneficio.toString()));
    sessionStorage.setItem('showcredito', Encode64(data.showCredito.toString()));
    sessionStorage.setItem('showcompratotal', Encode64(data.showCompratotal.toString()));
    sessionStorage.setItem('showcompramedia', Encode64(data.showCompramedia.toString()));
    sessionStorage.setItem('showcomprames', Encode64(data.showComprames.toString()));
    sessionStorage.setItem('showpago', Encode64(data.showPago.toString()));
    sessionStorage.setItem('showvencido', Encode64(data.showVencido.toString()));
    sessionStorage.setItem('showvencer', Encode64(data.showVencer.toString()));
    sessionStorage.setItem('showdocsdia', Encode64(data.showDocsdia.toString()));
    sessionStorage.setItem('showdocsatraso', Encode64(data.showDocsatraso.toString()));
